    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Category_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='diminuendo.category')),
            ],
        ),
        migrations.CreateModel(
            name='Sale',
            fields=[
                ...
                ('unit_price', models.IntegerField(blank=True, default=0, null=True)),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='diminuendo.product')),
            ],
        ),
    ]
